...
class EmotionRecognition:
    ...
    def run(self):
        ...
        print("Making Pre-processing model ok")
        ...
        print("Add Regression in Network ok")
        ...
        # Shared Memory
        shm_list = []
        shm_control = mmap.mmap(0, 230410, "KEY1")
        print("connet control shared memory ok")
        ...
        while True:
            ...
            if shm_control[0:1] == b'0':
                ...
                print("Trigger error! No 0, 1, 2, 3")
